...
import { deleteRouteAction } from "../actions/deleteRouteAction";
...
export function RouteDeleteDialog({ routeId, routeName, onSuccess, onCancel }: RouteDeleteDialogProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="text-center">
        <h3 className="text-lg font-bold text-gray-800">¿Eliminar ruta?</h3>
